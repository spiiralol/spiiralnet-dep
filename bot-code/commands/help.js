        ...
        ReactionCollector.paginator({
            ...
            pages: [
                new Discord.MessageEmbed()
                    .setTitle('General')
                    .addField('Create Invite', 'This creates an invite fot the server \n\tUsage: `createinvite`')
                ...
                new Discord.MessageEmbed()
                    ...
                    .addField('Lockdown', 'Starts a lockdown for that channel. The lockdown currently only effects `@everyone` \n\tUsage: `lockdown time`')
                ...
                //     .addField('Reaction Role Msg', 'Sets the message for the reaction role menu \n\tUsage: `rrmsg <#channel> message`'),
                new Discord.MessageEmbed()
                    .setTitle('Util')
